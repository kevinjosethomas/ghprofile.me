...
export default function Modal(props) {
  ...
  return (
    <div className="Modal w-full h-full fixed flex flex-row items-center justify-center z-100 inset-0">
      <div className="flex flex-row items-start justify-start px-6 py-8 bg-gray-300 rounded-lg max-w-xl">
